...
INSERT  IGNORE INTO `button_states` VALUES (80,'start_loading','Nachat zagruzku','driver','direction_slot_taken','active');
...
INSERT  IGNORE INTO `cell_access_tokens` VALUES (9,1526,'pickup',1,1001,'ae0f8336b9ca1c53ca1f3ea5184b54cc0de67740ffec36be10dcbe03a47d0fe7','935209','ACTIVE','2026-03-02 11:20:57',0,'2026-03-02 11:05:57',NULL);
...
INSERT  IGNORE INTO `cell_access_tokens` VALUES (11,1528,'pickup',6,1001,'87260ad86b07080225a45fc525d8f9216e787ac7be936a3e3c8f01c01505bc50','338651','ACTIVE','2026-03-15 14:01:22',0,'2026-03-15 13:46:22',NULL);
...
CREATE TABLE `directions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `status` varchar(50) DEFAULT 'direction_open',
...
INSERT  IGNORE INTO `directions` VALUES (1,'direction_slot_taken','МСК','СПБ',1,2,2,1,1);
...
INSERT  IGNORE INTO `driver_reservations` VALUES (1,200,1,1,1,'2026-03-15 13:51:32','2026-03-15 14:21:33','active');
...
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1026,'trip',33,'trip_start_trip','trip_assigned','trip_in_progress',201,'2026-02-25 07:27:34');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1027,'order',1519,'order_start_transit','order_picked_up_from_post1','order_in_transit_to_post2',201,'2026-02-25 07:27:34');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1028,'order',1520,'order_start_transit','order_picked_up_from_post1','order_in_transit_to_post2',201,'2026-02-25 07:27:34');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1029,'order',1525,'order_assign_courier1_to_order','order_created','order_courier1_assigned',100,'2026-02-25 11:44:51');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1030,'order',1525,'order_courier_pickup_parcel','order_courier1_assigned','order_courier_has_parcel',100,'2026-02-25 11:53:22');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1031,'locker',28,'locker_open_locker','locker_reserved','locker_opened',100,'2026-02-25 11:53:22');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1032,'order',1525,'order_confirm_parcel_in','order_courier_has_parcel','order_parcel_confirmed',100,'2026-02-25 11:53:37');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1033,'locker',28,'locker_close_locker','locker_opened','locker_occupied',100,'2026-02-25 11:53:37');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1034,'trip',36,'trip_vzyat_reis','trip_created','trip_assigned',201,'2026-02-25 12:06:18');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1035,'locker',28,'locker_open_locker','locker_occupied','locker_opened',201,'2026-02-25 12:10:48');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1036,'order',1525,'order_parcel_submitted','order_parcel_confirmed','order_parcel_submitted',201,'2026-02-25 12:10:48');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1037,'locker',28,'locker_close_pickup','locker_opened','locker_closed_empty',201,'2026-02-25 12:11:08');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1038,'order',1525,'order_pickup_by_voditel','order_parcel_submitted','order_picked_up_from_post1',201,'2026-02-25 12:11:08');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1039,'trip',36,'trip_start_trip','trip_assigned','trip_in_progress',201,'2026-02-25 12:12:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1040,'order',1525,'order_start_transit','order_picked_up_from_post1','order_in_transit_to_post2',201,'2026-02-25 12:12:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1041,'locker',38,'locker_open_locker','locker_reserved','locker_opened',201,'2026-02-25 12:15:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1042,'order',1525,'order_arrive_at_post2','order_in_transit_to_post2','order_arrived_at_post2',201,'2026-02-25 12:15:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1043,'order',1525,'order_confirm_post2','order_arrived_at_post2','order_parcel_confirmed_post2',201,'2026-02-25 12:16:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1044,'locker',38,'locker_close_locker','locker_opened','locker_occupied',201,'2026-02-25 12:16:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1045,'trip',36,'trip_vzyat_reis','trip_created','trip_assigned',201,'2026-02-26 08:30:07');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1048,'locker',28,'locker_open_locker','locker_occupied','locker_opened',201,'2026-02-26 08:36:42');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1049,'order',1525,'order_parcel_submitted','order_parcel_confirmed','order_parcel_submitted',201,'2026-02-26 08:36:42');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1050,'locker',28,'locker_close_pickup','locker_opened','locker_closed_empty',201,'2026-02-26 08:37:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1051,'order',1525,'order_pickup_by_voditel','order_parcel_submitted','order_picked_up_from_post1',201,'2026-02-26 08:37:03');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1052,'trip',36,'trip_start_trip','trip_assigned','trip_in_progress',201,'2026-02-26 08:40:48');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1053,'order',1525,'order_start_transit','order_picked_up_from_post1','order_in_transit_to_post2',201,'2026-02-26 08:40:48');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1054,'locker',38,'locker_open_locker','locker_reserved','locker_opened',201,'2026-02-26 08:41:33');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1055,'order',1525,'order_arrive_at_post2','order_in_transit_to_post2','order_arrived_at_post2',201,'2026-02-26 08:41:33');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1056,'order',1525,'order_confirm_post2','order_arrived_at_post2','order_parcel_confirmed_post2',201,'2026-02-26 08:41:53');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1057,'locker',38,'locker_close_locker','locker_opened','locker_occupied',201,'2026-02-26 08:41:53');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1058,'trip',36,'trip_complete_trip','trip_in_progress','trip_completed',201,'2026-02-26 11:39:23');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1059,'order',1525,'order_assign_courier2_to_order','order_parcel_confirmed_post2','order_courier2_assigned',103,'2026-02-27 08:16:29');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1060,'order',1525,'order_courier2_pickup_parcel','order_courier2_assigned','order_courier2_has_parcel',103,'2026-02-27 08:23:15');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1061,'locker',38,'locker_open_locker','locker_occupied','locker_opened',103,'2026-02-27 08:23:15');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1062,'order',1525,'order_courier2_delivered_parcel','order_courier2_has_parcel','order_courier2_parcel_delivered',103,'2026-02-27 08:24:25');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1063,'locker',38,'locker_close_pickup','locker_opened','locker_closed_empty',103,'2026-02-27 08:24:25');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1064,'trip',30,'trip_vzyat_reis','trip_created','trip_assigned',200,'2026-02-27 14:05:16');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1065,'trip',31,'trip_vzyat_reis','trip_created','trip_assigned',200,'2026-02-27 14:07:11');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1066,'order',1506,'order_assign_courier1_to_order','order_created','order_courier1_assigned',100,'2026-02-27 15:15:04');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1067,'order',1525,'order_recipient_confirmed','order_courier2_parcel_delivered','order_completed',103,'2026-02-28 07:42:17');
INSERT  IGNORE INTO `fsm_action_logs` VALUES (1068,'trip',32,'trip_vzyat_reis','trip_created','trip_assigned',201,'2026-03-08 08:17:42');
...
INSERT  IGNORE INTO `fsm_actions` VALUES (109,'direction_reserve_slot','Voditel vzyal slot');
INSERT  IGNORE INTO `fsm_actions` VALUES (110,'direction_start_loading','Nachat pogruzku');
INSERT  IGNORE INTO `fsm_actions` VALUES (111,'direction_complete_loading','Zavershit pogruzku');
INSERT  IGNORE INTO `fsm_actions` VALUES (112,'direction_expire_slot','Taymaut rezerva');
...
INSERT  IGNORE INTO `fsm_states` VALUES (105,'direction_open','Nappravlenie dostupno na birzhe');
INSERT  IGNORE INTO `fsm_states` VALUES (106,'direction_slot_taken','Slot zarezervirovan voditelem');
INSERT  IGNORE INTO `fsm_states` VALUES (107,'direction_loading','Voditel zagruzhaet zakazy');
INSERT  IGNORE INTO `fsm_states` VALUES (108,'direction_loading_finished','Pogruzka zavershena');
...
INSERT  IGNORE INTO `fsm_transitions` VALUES (138,105,109,106);
INSERT  IGNORE INTO `fsm_transitions` VALUES (139,106,110,107);
INSERT  IGNORE INTO `fsm_transitions` VALUES (140,107,111,108);
INSERT  IGNORE INTO `fsm_transitions` VALUES (141,106,112,105);
INSERT  IGNORE INTO `fsm_transitions` VALUES (142,107,112,105);
...
INSERT  IGNORE INTO `locker_cells` VALUES (1,1,'S-01','S','locker_reserved',1526,'2025-11-22 15:23:13','2026-03-02 09:03:01');
INSERT  IGNORE INTO `locker_cells` VALUES (2,1,'S-02','S','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (3,1,'S-03','S','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (4,1,'S-04','S','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (5,1,'M-01','M','locker_occupied',1527,'2025-11-22 15:23:13','2026-03-15 13:36:36');
INSERT  IGNORE INTO `locker_cells` VALUES (6,1,'M-02','M','locker_occupied',1528,'2025-11-22 15:23:13','2026-03-15 13:47:22');
...
INSERT  IGNORE INTO `locker_cells` VALUES (9,1,'P-01','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (10,1,'P-02','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (11,2,'S-01','S','locker_reserved',1526,'2025-11-22 15:23:13','2026-03-02 09:03:01');
INSERT  IGNORE INTO `locker_cells` VALUES (12,2,'S-02','S','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (13,2,'S-03','S','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (14,2,'S-04','S','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (15,2,'M-01','M','locker_reserved',1527,'2025-11-22 15:23:13','2026-03-15 13:26:16');
INSERT  IGNORE INTO `locker_cells` VALUES (16,2,'M-02','M','locker_reserved',1528,'2025-11-22 15:23:13','2026-03-15 13:44:12');
...
INSERT  IGNORE INTO `locker_cells` VALUES (19,2,'P-01','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (20,2,'P-02','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
...
INSERT  IGNORE INTO `locker_cells` VALUES (29,3,'P-01','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (30,3,'P-02','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
...
INSERT  IGNORE INTO `locker_cells` VALUES (39,4,'P-01','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (40,4,'P-02','P','locker_free',NULL,'2025-11-22 15:23:13','2026-03-02 09:02:49');
...
INSERT  IGNORE INTO `locker_cells` VALUES (43,1,'A03','M','locker_free',NULL,'2025-11-23 20:39:10','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (44,2,'B01','S','locker_free',NULL,'2025-11-23 20:39:10','2026-03-02 09:02:49');
INSERT  IGNORE INTO `locker_cells` VALUES (45,2,'B02','M','locker_free',NULL,'2025-11-23 20:39:10','2026-03-02 09:02:49');
...
INSERT  IGNORE INTO `orders` VALUES (1506,'order_courier1_assigned','parcel (S)','courier',NULL,'courier',2,13,'2026-02-27 15:15:04','2026-02-06 05:53:12',1003,NULL);
...
INSERT  IGNORE INTO `orders` VALUES (1527,'order_parcel_confirmed','parcel (M)','self',NULL,'self',5,15,'2026-03-15 13:36:36','2026-03-15 13:26:16',1001,2004);
INSERT  IGNORE INTO `orders` VALUES (1528,'order_parcel_confirmed','parcel (M)','self',NULL,'self',6,16,'2026-03-15 13:47:22','2026-03-15 13:44:12',1001,2004);
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (563,'order',1525,'open_cell','COMPLETED',NULL,1,NULL,'2026-02-25 11:53:19','2026-02-27 08:23:15',103,'courier',103,'courier','{}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (564,'order',1525,'close_cell','COMPLETED',NULL,1,NULL,'2026-02-25 11:53:33','2026-02-27 08:24:25',103,'courier',103,'courier','{}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (593,'order',1525,'request_locker_access_code','COMPLETED',NULL,1,NULL,'2026-02-28 06:03:26','2026-02-28 07:40:42',2004,'recipient',2004,NULL,'{\"leg\": \"delivery\"}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (595,'order',1525,'confirm_courier2_delivery','COMPLETED',NULL,1,NULL,'2026-02-28 06:16:31','2026-02-28 07:42:17',103,'courier',103,NULL,'{\"pin\": \"300592\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (601,'order',1514,'request_locker_access_code','FAILED',NULL,1,'USER_NOT_AUTHORIZED','2026-03-02 08:16:35','2026-03-02 08:53:00',1001,'client',1001,NULL,'{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (607,'order',1526,'request_locker_access_code','COMPLETED',NULL,1,NULL,'2026-03-02 09:04:33','2026-03-02 11:05:57',1001,'client',1001,'client','{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (612,'order',1527,'open_cell','COMPLETED',NULL,1,NULL,'2026-03-15 13:28:54','2026-03-15 13:35:51',1001,'client',1001,'client','{\"leg\": \"pickup\", \"pin\": \"768347\"}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (613,'order',1527,'request_locker_access_code','FAILED',NULL,1,'CODE_NOT_ALLOWED_IN_order_parcel_confirmed','2026-03-15 13:30:55','2026-03-15 13:45:27',1001,'client',1001,'client','{\"leg\": \"pickup\"}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (617,'order',1527,'close_cell','COMPLETED',NULL,1,NULL,'2026-03-15 13:36:34','2026-03-15 13:36:36',1001,'client',1001,'client','{}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (621,'order',1528,'request_locker_access_code','COMPLETED',NULL,1,NULL,'2026-03-15 13:46:20','2026-03-15 13:46:22',1001,'client',1001,'client','{\"leg\": \"pickup\"}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (622,'order',1528,'open_cell','COMPLETED',NULL,1,NULL,'2026-03-15 13:46:57','2026-03-15 13:47:02',1001,'client',1001,'client','{\"leg\": \"pickup\", \"pin\": \"338651\"}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (623,'order',1528,'close_cell','COMPLETED',NULL,1,NULL,'2026-03-15 13:47:20','2026-03-15 13:47:22',1001,'client',1001,'client','{}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (625,'direction',1,'direction_reserve_slot','COMPLETED',NULL,1,NULL,'2026-03-15 13:51:29','2026-03-15 13:51:32',200,'driver',200,'client','{\"capacity\": 1}');
...
INSERT  IGNORE INTO `stage_orders` VALUES (2,NULL,1363,'pickup',NULL,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (2,NULL,1364,'pickup',NULL,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (2,NULL,1364,'delivery',NULL,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (2,NULL,1365,'pickup',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (3,NULL,1367,'pickup',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (27,NULL,1502,'pickup',100,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (27,NULL,1502,'delivery',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (28,NULL,1506,'pickup',100,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (28,NULL,1506,'delivery',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (29,NULL,1508,'pickup',100,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (29,NULL,1508,'delivery',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (NULL,1,1527,'pickup',NULL,NULL,200);
INSERT  IGNORE INTO `stage_orders` VALUES (NULL,1,1527,'delivery',NULL,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (NULL,1,1528,'pickup',NULL,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (NULL,1,1528,'delivery',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `trips` VALUES (30,200,'СПБ','МСК',4,3,'trip_assigned',NULL,1,'2026-02-10 15:14:05');
...
BEGIN
	...
	ELSEIF p_entity_type = 'direction' THEN
		-- Получаем текущее состояние направления
		SELECT id, name INTO v_from_state_id, v_from_state_name
		FROM fsm_states
		WHERE name = (
			SELECT status FROM directions WHERE id = p_entity_id
		);

		IF v_from_state_id IS NULL THEN
			SIGNAL SQLSTATE '45000'
			SET MESSAGE_TEXT = 'Unknown from_state for direction in fsm_states';
		END IF;

		-- Ищем разрешённый переход
		SELECT ft.id, fs_to.name
		INTO v_to_state_id, v_to_state_name
		FROM fsm_transitions ft
		JOIN fsm_states fs_to ON fs_to.id = ft.to_state_id
		WHERE ft.from_state_id = v_from_state_id
		  AND ft.action_id = v_action_id;

		IF v_to_state_id IS NULL THEN
			SIGNAL SQLSTATE '45000'
			SET MESSAGE_TEXT = 'Invalid transition for direction: no matching fsm_transitions';
		END IF;

		-- Обновляем статус направления
		UPDATE directions
		SET status = v_to_state_name
		WHERE id = p_entity_id;
		...
		INSERT INTO fsm_action_logs (
			...
			'direction', p_entity_id, p_action_name, v_from_state_name, v_to_state_name, p_user_id, v_now
		);
