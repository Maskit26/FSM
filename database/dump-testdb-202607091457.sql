...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'd1786c4a-7afe-11f1-8f40-72ec1fe7dfc4:1-2006';
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `fsm_perform_transition` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER="avnadmin"@"%" PROCEDURE "fsm_perform_transition"(
    IN p_entity_type VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_entity_id INT,
    IN p_transition_id INT,
    IN p_event_name VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_user_id INT
)
BEGIN
    ...
    SELECT CONCAT('FSM transition completed: ', v_from_state_name, ' -> ', v_to_state_name) AS result;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2026-07-09 14:58:56
