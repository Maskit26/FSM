...
INSERT  IGNORE INTO `cell_access_tokens` VALUES (14,1526,'pickup',1,1001,'bf1c61bcd21d5eed7461f824ba0ac454f00e226e8288fe9184ba17d48053f40d','876479','ACTIVE','2026-03-16 12:51:11',0,'2026-03-16 12:36:11',NULL);
...
INSERT  IGNORE INTO `directions` VALUES (1,'МСК','СПБ',1,2,1,1);
...
INSERT  IGNORE INTO `locker_cells` VALUES (5,1,'M-01','M','locker_closed_empty',1527,'2025-11-22 15:23:13','2026-03-18 16:15:32');
...
INSERT  IGNORE INTO `locker_cells` VALUES (10,1,'P-02','P','locker_reserved',1531,'2025-11-22 15:23:13','2026-03-19 07:44:10');
...
INSERT  IGNORE INTO `orders` VALUES (1363,'order_courier1_assigned','Заказ A (S)','courier',NULL,'courier',1,12,'2026-03-19 14:45:55','2025-12-15 19:42:02',0,NULL);
...
INSERT  IGNORE INTO `orders` VALUES (1531,'order_courier1_assigned','letter (P)','courier',NULL,'courier',10,20,'2026-03-20 12:55:03','2026-03-19 07:44:10',1001,2004);
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (410,'order',1508,'request_locker_access_code','FAILED',NULL,1,'USER_NOT_AUTHORIZED','2026-02-11 17:44:14','2026-03-16 12:41:56',1001,'client',1001,NULL,'{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (593,'order',1525,'request_locker_access_code','FAILED',NULL,1,'CODE_NOT_ALLOWED_IN_order_completed','2026-02-28 06:03:26','2026-03-20 05:48:32',2001,'recipient',2001,NULL,'{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (601,'order',1514,'request_locker_access_code','FAILED',NULL,1,'USER_NOT_AUTHORIZED','2026-03-02 08:16:35','2026-03-17 14:43:21',1001,'client',1001,NULL,'{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (607,'order',1526,'request_locker_access_code','COMPLETED',NULL,1,NULL,'2026-03-02 09:04:33','2026-03-16 12:36:11',1001,'client',1001,NULL,'{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (621,'order',1528,'request_locker_access_code','FAILED',NULL,1,'CODE_NOT_ALLOWED_IN_order_parcel_confirmed','2026-03-15 13:46:20','2026-03-16 09:13:16',2001,'recipient',2001,NULL,'{\"leg\": \"pickup\"}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (625,'direction',1,'direction_reserve_slot','COMPLETED',NULL,1,NULL,'2026-03-15 13:51:29','2026-03-19 16:03:52',200,'driver',200,'driver','{\"capacity\": 2}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (641,'direction',1,'direction_start_loading','COMPLETED',NULL,1,NULL,'2026-03-16 13:29:08','2026-03-18 14:26:20',200,'driver',200,'driver','{}');
INSERT  IGNORE INTO `server_fsm_instances` VALUES (650,'direction',1,'direction_complete_loading','COMPLETED',NULL,1,NULL,'2026-03-17 15:47:09','2026-03-18 16:26:08',200,'driver',200,'driver','{}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (714,'order',1531,'close_cell','FAILED',NULL,1,'FSM order_confirm_parcel_in failed: 1644 (45000): Invalid transition for order: no matching fsm_transitions','2026-03-20 10:19:34','2026-03-20 14:47:39',1001,'client',1001,NULL,'{}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (729,'order',1531,'request_locker_access_code','FAILED',NULL,1,'MISSING_METADATA','2026-03-20 13:50:07','2026-03-20 14:47:54',1001,'client',1001,NULL,'{}');
...
INSERT  IGNORE INTO `server_fsm_instances` VALUES (732,'order',1531,'open_cell','FAILED',NULL,1,'MISSING_PIN_IN_METADATA','2026-03-20 14:47:25','2026-03-20 14:47:29',1001,'client',1001,NULL,'{}');
...
INSERT  IGNORE INTO `stage_orders` VALUES (1,NULL,5,'pickup',100,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (2,NULL,1363,'pickup',100,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (38,1,1527,'pickup',NULL,5,200);
INSERT  IGNORE INTO `stage_orders` VALUES (38,1,1527,'delivery',NULL,NULL,NULL);
...
INSERT  IGNORE INTO `stage_orders` VALUES (NULL,NULL,1531,'pickup',100,NULL,NULL);
INSERT  IGNORE INTO `stage_orders` VALUES (NULL,NULL,1531,'delivery',NULL,NULL,NULL);
